...
#                 # pregunta = resultado + "explicar el siguiente articulo del codigo civil y comercial argentino"
                
#                 # contesta = bard.get_answer(pregunta)['content']
#                 # st.write("Articulo Relacionado")
#                 return resultado
#                 # return resultado
#         return None
...
#             if "juris" not in st.session_state:
#                 st.session_state.juris = ""
#             busquedaweb = texto + ' segun codigo civil y comercial de argentina, jurisprudencia argentina relacionada'
...
# respuestafinal = bard.get_answer(explicacionarticulo)['content']
# varrespuestafinal = st.expander("Ver Articulos Mencionados en La Respuesta")
# varrespuestafinal.write(respuestafinal)
# verresultados = st.expander("Ver jurisprudencia Encontrada en la Web")
